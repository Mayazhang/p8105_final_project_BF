...
model1 = lm(burglary_rate ~ illicit_drugs + alcohol + marijuana + total_pop_thousands + white, data = new_reg_data)
par(mfrow = c(2,2))
plot(model1)
model2 = lm(robbery_rate ~ illicit_drugs + alcohol + marijuana + total_pop_thousands + white, data = new_reg_data)
par(mfrow = c(2,2))
plot(model2)
model3 = lm(murder_manslaughter_rate ~ illicit_drugs + alcohol + marijuana + total_pop_thousands + white, data = new_reg_data)
par(mfrow = c(2,2))
plot(model3)
```
