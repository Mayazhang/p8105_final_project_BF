...
model1 = lm(burglary_rate ~ illicit_drugs + alcohol + marijuana + total_pop_thousands, data = new_reg_data)
par(mfrow = c(2,2))
plot(model1)
```
...
* Each simple linear regression

```{r}
lm(murder_manslaughter_rate ~ alcohol, data = new_reg_data) %>% summary()
lm(burglary_rate ~ alcohol, data = new_reg_data) %>% summary()
lm(robbery_rate ~ marijuana, data = new_reg_data) %>% summary()
```
...
See the crime distribution at different geographic levels.
```{r distribution of violent crime rate}
# At state level
ggplot(crime_clean, aes(x = state, y = violent_crime_rate, color = as.factor(year))) + geom_point() +
  theme_bw() +
...
# At area level
ggplot(crime_largearea, aes(x = area, y = violent_crime_rate, color = as.factor(year))) + geom_point() +
  theme_bw() +
...
# In the midwest area
ggplot(crime_midwest, aes(x = area, y = violent_crime_rate, color = as.factor(year))) + geom_point() +
  theme_bw() +
  theme(axis.text.x = element_text(size = 10)) +
  labs(
...
ggplot(crime_northeast, aes(x = area, y = violent_crime_rate, color = as.factor(year))) + geom_point() +
  theme_bw() +
  theme(axis.text.x = element_text(size = 10)) +
  labs(
...
# In the south area
ggplot(crime_south, aes(x = area, y = violent_crime_rate, color = as.factor(year))) + geom_point() +
  theme_bw() +
  theme(axis.text.x = element_text(size = 10)) +
  labs(
...
# In the west area
ggplot(crime_west, aes(x = area, y = violent_crime_rate, color = as.factor(year))) + geom_point() +
  theme_bw() +
  theme(axis.text.x = element_text(size = 10)) +
  labs(
