...
```{r drug dataset load and clean up, echo=FALSE, warning=FALSE}
...
```{r prepare the outcome and predictors, echo=FALSE, warning=FALSE}
# clean drug data
...
```{r read in new dataset, echo=FALSE, warning=FALSE}
...
```{r model diagnostics, echo=FALSE, warning=FALSE}
...
```{r linear regression_another, echo=FALSE, warning=FALSE}
# MLR linear regression using list columns
...
```{r model diagnostics_another, echo=FALSE, warning=FALSE}
# Fit models and then check the assumption
