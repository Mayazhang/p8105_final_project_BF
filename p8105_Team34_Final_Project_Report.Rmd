...
Finally, to show the different rates in each drug use overall the whole country, a shiny map was made to explore the distribution of each drug use in the U.S. in 2015 and 2016 respectively, and the color gradient corresponds to drug rate.
