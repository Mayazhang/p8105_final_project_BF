...
Spaghetti plots showing the trend of drug use across years
...
From the plots, marijuana rate among age 18-25 has the highest rate among all and there is a slight decrease in alcohol use in all age groups. The rates of both illicit drugs--cocaine and marijuana remain constant through years.

* Process of building shiny for drug data:

There were 51 states, three types of drugs (marijuana, illicit drug, alcohol), three age groups (12-17, 18-25, 26 or above) and four or five degrees in each drug (abuse, binge, dependence, need treatment, use). The main purpose was to analyze the distribution of degrees in each drug in each state throughout years and the distribution of degrees of each drug stratified by age. Moreover, there were data for rate of perception risk in marijuana and alcohol use, thus we  analyzed the trend of perception risk in each age group and in each state for selected drugs. Thus, three interactive charts in total were created for exploratory purpose.

In chart A, specific state and drug type have been selected, and then an interactive bar chart with “year” as x axis, “rate” as y axis was built with different color representing the degree of drug addiction. In chart B, the distribution of perception of risk for alcohol and marijuana by three age groups were plotted across years. In chart C, the distributions of drug rates with degree of drug addiction across year were plotted for each drug type and for each group. As a result, each degree was colored to show the drug rate change in a certain group.
...
The crime data consists of a total of ten types of crimes (violent, murder and manslaughter, rape, robbery, aggravated assult, proporty, burglary, larceny and theft, motor vehicle theft) and two year points (2015 and 2016).

Twenty barplots were created to exhibit the distributions of ten types of crime rates across states in 2015 and 2016 respectively, corresponding maps were made to represent information in the barplots.
