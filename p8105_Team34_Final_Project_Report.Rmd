...
The data was collected by FBI's Uniform Crime Reporting (UCR) Program, which recorded different types of offenses by states, regions, or geographic divisions. The data presented each crime by volumn and rate per 100,000 inhabitants. There are two major categories of crimes: (1) violent_crime_number/rate: violent crime involved force or threat of force against the victims. It included four types of offenses: murder and nonnegligent manslaughter, rape, robbery, and aggravated assault. Columns containing murder manslaughter, rape, robbery, and aggravated assault were subdivision of violent crime. (2) Property_crime_number/rate: property crime indicated offenses involving property lost without force or threat of force. It included three types of offenses: burglary, larceny-theft, motor vehicle theft. Columns containing burglary, larceny-theft, and motor vehicle theft were subdivision of property crime
...
The crime dataset was loaded from the [google sheet](https://docs.google.com/spreadsheets/d/1iYhSFxs_IdRDrfrn1xqdK6uesNKWRjCIJ2GYloO0Ll8/edit#gid=249460096), detailed data cleaning steps were as follow: column names were cleaned up using 'janitor' packages and the subscripts of text were manually deleted. Column 'area' was convert from character to factor. Commas were removed in columns containing numbers and rates, followed by transformation from character to numeric. Area names were filled where appropriate. 'rape_legacy' variable was deleted as it has overlapping information with 'rape_revise' columns. Additionally, NAs were removed. Also, subsets by states, region, and geographic division were created.
...
Taking the race proportion into consideration, we added proportion of whites as a potential confounder. It was extracter from [Kaiser Family Foundation](https://www.kff.org/other/state-indicator/distribution-by-raceethnicity/?currentTimeframe=0&sortModel=%7B%22colId%22:%22Location%22,%22sort%22:%22asc%22%7D)
...
From the plot, we could see that marijuana rate among age 18-25 obtained the highest rate among all and we could observe a slight decrease in alcohol use in all age groups. Both illicit drugs such as cocaine and marijuana kept steady rates through years.
...
Surprisingly, the rate of perception risk of marijuana was continuously reduced over years in all age groups while that of alcohol fluctuated a little bit. This trend indicated potential higher popularity of marijuana in whole U.S. and less perception of marijuana risk. We expected further education in disadvantages of marijuana use.
...
Our finding are that, in general, the crime rate is not highly related to alcohol, marijuana nor illicit drug use. It is associated to the race proportion of whites and the percentage of high school graduation.
